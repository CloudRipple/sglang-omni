...
MOSS_TD_CER_PERCENT_MAX: float | None = 6.612385102255017
MOSS_TD_CER_NO_SPK_PERCENT_MAX: float | None = 6.612385102255017
MOSS_TD_CP_CER_PERCENT_MAX: float | None = 13.0
MOSS_TD_CER_NO_SPK_CP_VALID_PERCENT_MAX: float | None = 6.51
MOSS_TD_DELTA_CER_PERCENT_MAX: float | None = 6.49
MOSS_TD_CER_VALID_SAMPLES_MIN: int | None = 784
MOSS_TD_CP_CER_VALID_SAMPLES_MIN: int | None = 773
MOSS_TD_THROUGHPUT_QPS_MIN: float | None = 33.761
MOSS_TD_LATENCY_MEAN_S_MAX: float | None = 0.467
MOSS_TD_LATENCY_P95_S_MAX: float | None = 1.083
MOSS_TD_RTF_MEAN_MAX: float | None = 0.0456
MOSS_TD_RTF_P95_MAX: float | None = 0.0782
