...
# TODO: Fill thresholds after CI calibration.
MOSS_TD_CER_PERCENT_MAX: float | None = None
MOSS_TD_CER_NO_SPK_PERCENT_MAX: float | None = None
MOSS_TD_CP_CER_PERCENT_MAX: float | None = None
MOSS_TD_CER_NO_SPK_CP_VALID_PERCENT_MAX: float | None = None
MOSS_TD_DELTA_CER_PERCENT_MAX: float | None = None
MOSS_TD_CER_VALID_SAMPLES_MIN: int | None = None
MOSS_TD_CP_CER_VALID_SAMPLES_MIN: int | None = None
MOSS_TD_THROUGHPUT_QPS_MIN: float | None = None
MOSS_TD_LATENCY_MEAN_S_MAX: float | None = None
MOSS_TD_LATENCY_P95_S_MAX: float | None = None
MOSS_TD_RTF_MEAN_MAX: float | None = None
MOSS_TD_RTF_P95_MAX: float | None = None
